...
function Rowtable({ treatmentId, priority, id, name, med, quantity, lote, date, onDelete, onCheck }) {
  ...
  return (
      <div className="row-table shadow">
        ...
        <div className="actions-column-table">
          ...
          <button className="action-btn edit-btn" aria-label="Check" onClick={() => onCheck(treatmentId)}>
            <FaCalendarCheck />
          </button>
        </div>
      </div>
